...
import { FallingLeaves, Fireflies, HudPill, IconButton, LumenPill, Twinkles, WoodButton } from './ui'
...
export function HomeScreen({
  ...
  return (
    <div className="relative flex-1 flex flex-col overflow-hidden">
      ...
      {/* center content — logo upper third, PLAY just below center */}
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center gap-6 px-6">
        <div className="flex flex-col items-center gap-6 translate-y-4 sm:translate-y-6">
          <img
            src={A('logo')}
          ...
          <WoodButton size="sm" className="w-full max-w-[200px]" onClick={onHowTo} ariaLabel="How to play">
            How to Play
          </WoodButton>
        </div>
      </main>
      ...
      <img
        ...
        aria-hidden
        draggable={false}
        className="pointer-events-none select-none absolute left-2 bottom-[92px] z-10 w-20 sm:w-24 anim-bob drop-shadow-[0_8px_16px_rgba(0,0,0,0.45)]"
      />
