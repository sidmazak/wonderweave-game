...
| Win / lose overlays | Folio sealed / lost | Same | **NOT TESTED** | — | Requires completing/failing a level |
...
| Release build | N/A | `assembleRelease` | **PASS** | `app-release.apk`, assemble log | Signed local release keystore |
